 ...
 * Article
 *
 * @ORM\Table(name="article", indexes={@ORM\Index(name="fkIdx_136", columns={"id_employe"}), @ORM\Index(name="fkIdx_139", columns={"id_rubrique"})})
...
class Article
{
     ...
     * @var DateTime
     *
     * @ORM\Column(name="date_cr̩ation_article", type="date", nullable=false)
     */
