...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 09 mai 2022 à 10:58
...
CREATE TABLE `client` (
  ...
  `abonnement_newsletter` binary(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'BRISEBARD', 'Jules-Maël', '$argon2i$v=19$m=65536,t=4,p=1$L251cmgvTEE0VGR0aDM5MA$bVG/2zix++1tNT+HIRt/RX/5F8v3jZKVVyhaDAdZfHg', 'brisebard.julesmael@laposte.net', '11 impasses', '25190', 'Saint-Hippolyte', '0707070707', 0x00),
(2, 'DUPOND', 'Jean', 'secret', 'dupond.jean@gmail.com', 'La rue', '25000', 'Besançon', '0785964203', 0x00);
...
(1, 1, 3, '2022-04-13 20:50:00', 25),
(2, 1, 3, '2022-05-04 20:52:07', 10);
...
INSERT INTO `employe` (`id_employe`, `id_role`, `role_JWT`, `nom`, `prenom`, `mot_de_passe`, `mail`, `lib_rue`, `CP_ville`, `ville`, `tel`, `date_embauche`) VALUES
(1, 2, NULL, 'BRISEBARD', 'Jules-Maël', '$argon2i$v=19$m=65536,t=4,p=1$LzRHUzV5Z09oOHQ0LlVDYw$wUHUfq2NanNCHADXEQdx+j0ppkbS68mJ5J61wLb1fd8', 'brisebard.julesmael@gmail.com', 'Rue des villes', '25190', 'Saint-Hippolyte', '0707070707', '2021-12-01 09:26:31'),
(2, 1, NULL, 'CHIADOT', 'Tom', '$argon2i$v=19$m=65536,t=4,p=1$V3Y3OW81RW1hdk9tejhFag$qH5396hYmA8ms4aC1VG4NEjTUIHaIVxhMl2TyYMjuZo', 'chiadot.tom@gmail.com', 'edsfezge', '25000', 'efze', 'efzef', '2022-01-03 15:48:52'),
(3, 3, NULL, 'JEAN', 'Jaque', 'secret', 'jean.jaque@gmail.com', '8 rue des licornes', '25000', 'Besançon', '0667895594', '2021-12-01 09:26:31'),
(5, 1, NULL, 'regre', 'ferf', 'ferf', 'rfef', 'ferffferef', 'ferf', 'ferf', 'efrf', '0000-00-00 00:00:00');
...
(1, 'Nougatine noisettes - 150g', 3, 2, 'Fabrication artisanale par la Confiserie \"La Sucrerie\" - 39600 Arbois, JURA\nIngrédients : glucose, sucre, noisettes, beurre', 6.9, NULL, 1, 1),
(2, 'Miel acacia - 250g', 3, 2, 'Miel du JURA - 39190 Val-Sonnette', 15, NULL, 1, 1),
(3, 'Eau tonique nature', 3, 2, 'EAU TONIQUE NATURE HYSOPE :\nFruit de l\"artisanat français sur l\"intégralité de sa chaîne de production, l\"eau tonique HYSOPE est élaborée à partir d\"ingrédients d\"origine biologique, dont l\"ensemble des recettes est certifiée ECOCERT. Tous les arômes sont sélectionnés à Grasse, capitale du parfum.\n\nPour twister vos cocktails, sublimer vos spiritueux ou simplement se déguster bien fraîche l\"eau tonique HYSOPE saura vous accompagner lors de vos apéritifs. ', 1, NULL, 1, 1),
(4, 'Eau tonique concombre', 3, 2, 'EAU TONIQUE CONCOMBRE HYSOPE :\nFruit de l\"artisanat français sur l\"intégralité de sa chaîne de production, l\"eau tonique HYSOPE est élaborée à partir d\"ingrédients d\"origine biologique, dont l\"ensemble des recettes est certifiée ECOCERT. Tous les arômes sont sélectionnés à Grasse, capitale du parfum.\n\nPour twister vos cocktails, sublimer vos spiritueux ou simplement se déguster bien fraîche l\"eau tonique HYSOPE saura vous accompagner lors de vos apéritifs.', 1.5, NULL, 1, 1),
(5, 'Eau tonique gingembre', 3, 2, 'EAU TONIQUE GINGEMBRE HYSOPE :\nFruit de l\"artisanat français sur l\"intégralité de sa chaîne de production, l\"eau tonique HYSOPE est élaborée à partir d\"ingrédients d\"origine biologique, dont l\"ensemble des recettes est certifiée ECOCERT. Tous les arômes sont sélectionnés à Grasse, capitale du parfum.\n\nPour twister vos cocktails, sublimer vos spiritueux ou simplement se déguster bien fraîche l\"eau tonique HYSOPE saura vous accompagner lors de vos apéritifs.', 0, NULL, 1, 1),
(6, 'Eau tonique citron', 3, 2, 'EAU TONIQUE CITRON HYSOPE :\nFruit de l\"artisanat français sur l\"intégralité de sa chaîne de production, l\"eau tonique HYSOPE est élaborée à partir d\"ingrédients d\"origine biologique, dont l\"ensemble des recettes est certifiée ECOCERT. Tous les arômes sont sélectionnés à Grasse, capitale du parfum.\n\nPour twister vos cocktails, sublimer vos spiritueux ou simplement se déguster bien fraîche l\"eau tonique HYSOPE saura vous accompagner lors de vos apéritifs.', 0, NULL, 1, 1),
(7, 'Eau tonique fleur de sureau', 3, 2, 'EAU TONIQUE FLEUR DE SUREAU HYSOPE :\nFruit de l\"artisanat français sur l\"intégralité de sa chaîne de production, l\"eau tonique HYSOPE est élaborée à partir d\"ingrédients d\"origine biologique, dont l\"ensemble des recettes est certifiée ECOCERT. Tous les arômes sont sélectionnés à Grasse, capitale du parfum.\n\nPour twister vos cocktails, sublimer vos spiritueux ou simplement se déguster bien fraîche l\"eau tonique HYSOPE saura vous accompagner lors de vos apéritifs.', 0, NULL, 1, 1),
(8, 'Miel sapin - 250g', 3, 2, 'Miel du JURA - 39190 Val-Sonnette', 0, NULL, 1, 1),
(9, 'Miel fleurs sauvages - 250g', 3, 2, 'Miel du JURA - 39190 Val-Sonnette', 0, NULL, 1, 1),
...
(11, 'Guimauve vanille', 3, 2, '', 0, NULL, 1, 1),
(12, 'Dragée fruitée - abricot 150g', 3, 2, '\nDragée Reynaud, confiseur de la région de Marseille, détourne la dragée traditionnelle avec des recettes des plus gourmandes. ', 0, NULL, 1, 1),
...
(16, 'Amande chocolat noir - 100g', 3, 2, '', 0, NULL, 1, 1),
(17, 'Bille croustillante chocolat lait - 100g', 3, 2, '', 0, NULL, 1, 1),
(18, 'Le Café Sigalas - 150g', 3, 2, '', 0, NULL, 1, 1),
(19, 'Filtre x100', 3, 2, '', 3.99, NULL, 1, 1),
(20, 'Valrhona - Jivara 40%', 3, 2, 'Jivara, par sa douceur cacaotée et maltée, est un chocolat chaleureux comme les rayons dorés du soleil à l\"aube d\"un matin d\"été.\n\nDéveloppé en 1995, Valrhona fait évoluer les codes du chocolat au lait avec Jivara, premier chocolat au lait à proposer une telle force gustative, avec un véritable goût de cacao. Pour atteindre ce goût singulier, Jivara est issu d\"un assemblage complexe de profils aromatiques de cacaos typiques d\"Equateur et du Ghana. ', 0, NULL, 1, 1),
(21, 'Valrhona - Dulcey 35%', 3, 2, 'Dulcey, par sa douceur biscuitée très légèrement salée et son goût de lait caramélisé, à ce don de nus renvoyer en enfance, de nousf aire voyager dans un tourbillon de souvenirs délicieux propres à chacun.\nEn 2012, Valrhona invente la quatrième couleur de chocolat : le blond. Laissant du chocolat blanc au bain-marie trop longtemps, Frédéric Bau découvre un surprenant résultat, le chocolat est devenu blond et laisse échapper une douce odeur. Dulcey est une ode à la créativité et à l\"audace qui révolutionne le monde de la pâtisserie pour offrir de nouvelles émotions grâce à a couleur son goût et sa texture. ', 14, NULL, 1, 1),
(22, 'Valrhona - Ivoire 35%', 3, 2, 'Les notes réconfortantes de lait cuit de chocolat blanc Ivoire font écho aux éclats de rire d\"enfants qui partagent ensemble leurs plus grands moments de bonheur. \nAvec Ivoire, Valrhona se démarque de l\"univers traditionnel des chocolats blancs, grâce à sa note sucrée tout en légèreté et sa couleur subtilement nacrée. \nRéférence iconique, Ivoire est devenu le mot générique parmi les professionnels de la gastronomie pour désigner le chocolat blanc.', 44, NULL, 1, 1),
(23, 'Valrhona - Caraïbe 66%', 3, 2, 'Caraïbe, avec ses notes amères intenses et ses accents boisés et de fruits secs grillés, fait rêver à une danse envoûtante à l\"ombre des cacaoyers. \nRéférent des chocolats équilibrés depuis 1988, Caraïbe est issu d\"un assemblage complexe de profils aromatiques de cacaos typiques de République Dominicaine, Equateur, Jamaïque et Togo pour atteindre ce goût singulier. Caraïbe est ainsi nommé car il rend hommage à la diversité des îles Caraïbes, dont les fèves ont inspiré sa création. ', 11, NULL, 1, 1),
(24, 'Thé noir Par Amour - 100g', 3, 2, 'Un thé noir aux saveurs de cerise parsemé de pétales de rose et de cœur en sucre. \nUne façon gourmande et délicate de dire JE T\"AIME à ceux qui sont chers à notre cœur... \nA la fois fruité, parfumé et sucré ce thé saura mettre vos pailles en extase. Les pétales de rose qu\"il contient remplaceront volontiers le traditionnel bouquet de fleurs de la Saint Valentin... ', 10, NULL, 1, 1),
(25, 'Valrhona - Oriado 60% 1kg', 3, 2, 'La douceur onctueuse et vanillée d\"Oriado invite à une sieste sur le sable chaud, avec la caresse enveloppante du soleil sur la peau. \nCréé en 2015, Oriado se distingue à la dégustation par sa légèreté et son équilibre. Issu de la gamme certifée, Oriado est l\"expression visible de l\"engagement de Valrhona, pour sa qualité et la traçabilité de la filière cacao. \nOriado est réalisé exclusivement à partir des meilleures matières premières biologiques, issues du commerce équitable (certifié Fairtrade/ Max Havelaar et issu de l\"Agriculture Biologique)', 16, NULL, 1, 1),
(26, 'GEISHA DU PANAMA - 150g', 3, 2, '', 13, NULL, 1, 1),
(27, 'Thé vert citron - 15 infusettes', 3, 2, '', 5, NULL, 1, 1),
(28, 'Delonghi Dinamica 3515B', 3, 2, 'Système Boissons lactées : Buse vapeur simple\nBoissons réalisable : Expresso, Café Long (Lungo), Café, Café Filtre (basse pression), Mousse de lait manuel, Eau chaude\nTrappe à moulu : Oui\nNombre de réglages du Broyeur : 13 positions\nRéglage intensité café : 5\nTempérature de percolation programmable : 3 niveaux\nInterface : Touches tactiles\nType d\"écran : Écran à texte LCD\nType de Broyeur Acier\n2 cafés simultanés : Oui\nRinçage des buses : Automatique\nEntretien du Groupe Café Manuel : groupe café extractible\nPression de la pompe : 15 Bars\nGarantie : 3 ans\nColoris : Noir\nMatériau(x) : ABS Mat\nVolume du réservoir à eau : 1.8 l\nVolume du bac à grain : 300 g\nNombre de bac à grains  : 1 bac\nVolume du bac à marcs : 14 galettes\nDimensions (LxPxH) : 236 x 429 x 348 mm\nPoids  : 9.5 Kg\nPuissance (en Watts) : 1450 W\nCapacité journalière : jusqu\"à 30 cafés/jour', 30, NULL, 1, 1),
(29, 'Infuseur Gladys', 3, 2, '', 12, NULL, 1, 1),
(30, 'Infuseur hippopotame', 3, 2, '', 4, NULL, 1, 1),
(31, 'Dragée Reyanud - Mûre 150g', 3, 2, '', 19, NULL, 1, 1),
(32, 'Amande crème de nougat - 140g', 3, 2, '', 7, NULL, 1, 1),
(33, 'Détartrant Delonghi', 3, 2, '', 40, NULL, 1, 1),
(34, 'Cartouche filtrante Delonghi', 3, 2, '', 14, NULL, 1, 1),
(35, 'Rooibos caramel - 100g', 3, 2, '', 7, NULL, 1, 1),
(36, 'Earl Grey - 15 infusettes', 3, 2, '', 30, NULL, 1, 1),
(37, 'Secret d\'Antan - 15 infusettes', 3, 2, '', 41, NULL, 1, 1),
(38, 'Peps - 15 infusettes', 3, 2, '', 46, NULL, 1, 1),
(39, 'Gyokuro - 100g', 3, 2, '', 38, NULL, 1, 1),
(40, 'Honeybush chocolat - 100g', 3, 2, '', 2, NULL, 1, 1),
(41, 'Maté latino - 100g', 3, 2, '', 43, NULL, 1, 1),
(42, 'Infusion Yetchuno - 100g', 3, 2, '', 27, NULL, 1, 1),
(43, 'Namas\'thé 100g', 3, 2, '', 3, NULL, 1, 1),
(44, 'Infusion d\'antan - 100g', 3, 2, '', 43, NULL, 1, 1),
(45, 'Thé blanc grenade cassis aloe 100g', 3, 2, '', 49, NULL, 1, 1),
(46, 'Thé blanc framboise tonka 50g', 3, 2, '', 19, NULL, 1, 1),
(47, 'Papouasie Nouvelle Guinée', 3, 2, '', 25, NULL, 1, 1),
(48, 'Bonbon d\'anis 100g', 3, 2, '', 41, NULL, 1, 1),
(49, 'Thé vert menthe - 15 infusettes', 3, 2, '', 25, NULL, 1, 1),
(50, 'Zen - 15 infusettes', 3, 2, '', 19, NULL, 1, 1),
(51, 'La délicieuse - 15 infusettes', 3, 2, '', 35, NULL, 1, 1),
(52, 'Croisière sur le Nil - 15 infusettes', 3, 2, '', 38, NULL, 1, 1),
(53, 'Thé vert menthe - 100g', 3, 2, '', 16, NULL, 1, 1),
(54, 'Infusion verveine - 50g', 3, 2, '', 37, NULL, 1, 1),
(55, 'Pu Erh - 100g', 3, 2, '', 29, NULL, 1, 1),
(56, 'Cerise sauvage - 15 infusettes', 3, 4, 'Pomme, Cynorrhodon, Hibiscus, Cerise sauvage (3%), arômes', 45, NULL, 1, 1),
(57, 'Zen', 3, 4, 'Oranger Doux pétale, Passiflore des Indes, Camomille Matricaire, Mélisse, Coquelicot', 46, NULL, 1, 1),
(58, 'Thé blanc Bai Mu Dan - 15 infusettes', 3, 4, 'Thé blanc de Chine', 14, NULL, 1, 1),
(59, 'Lendemain de fête - 15 infusettes', 3, 4, 'Thé Noir, Badiane, Tilleul Aubier, Gingembre, Réglisse', 6, NULL, 1, 1),
(60, 'English Breakfast - 15 infusettes', 3, 4, 'Thé noir', 29, NULL, 1, 1),
(61, 'Sencha douce saveur - 15 infusettes', 3, 4, 'Thé vert Sencha (70%), Raisin de Corinthe, Pétale de rose, arômes,  Ananas, Papaye, Fraise, Framboise', 36, NULL, 1, 1),
(62, 'Thé vert bio - 15 infusettes', 3, 4, 'Thé vert Bio', 5, NULL, 1, 1),
(63, 'Detox Automne hiver - 15 infusettes', 3, 4, 'Thé vert feuille, Chicorée feuille, Citron écorce, Chiendent Officinal racine', 5, NULL, 1, 1),
(64, 'Brésil', 3, 9, 'Premier pays producteur de café, ce cru du Brésil de chez Daterra vous surprendra par ses notes sucrées et fruitées.', 30, NULL, 1, 1),
(65, 'Ethiopie Yrgacheffe', 3, 9, 'Issu de la célèbre région d\"Ethiopie Yrgacheffe, ce café est récolté à pleine maturité, puis laissé fermenter sous eau de 24 à 36 heures afin de développer ses arômes d\"une rare délicatesse', 25, NULL, 1, 1),
(66, 'Mexique Décaféiné', 3, 9, 'Un décaféiné mexicain issu d\"un process naturel à l\"eau et crédité du label biologiqueLabel : Bio', 4, NULL, 1, 1),
(67, 'Pérou El Palto', 3, 9, 'L\"association JUMARP qui gère cette coopérative a pour objectifs d\"aider fiancièrement les producteurs et d\"améliorer leurs conditions de travail mais aussi en finançant la construction d\"école Label : Bio', 39, NULL, 1, 1),
(68, 'Blend de la Brûlerie', 3, 9, 'Un café rond et subtil 100% arabica avec ses notes de chocolat et de fruits secs', 38, NULL, 1, 1),
(69, 'Mélange italien', 3, 9, 'Un café corsé comme dans la tradition italienne avec ses notes de cacao et animal', 11, NULL, 1, 1),
(70, 'Honduras', 3, 9, 'Ce Cru du Honduras vous fera voyager dans ce pays emblématique de la production de café', 32, NULL, 1, 1),
(71, 'Indonésie', 3, 9, '', 12, NULL, 1, 1),
(72, 'Le Café Sigalas - 10 capsules', 3, 9, '', 19, NULL, 1, 1),
(73, 'Colombie', 3, 10, 'Issu d\"un microlot de Colombie, ce café vous ravira par ses notes subtiles et suaves', 31, NULL, 1, 1),
(74, 'Ethiopie Guji', 3, 11, 'Berceau du café, ce cru produit dans la région de Guji est séché naturellement au soleil pour transférer les sucres présent dans la chair du fruit au grain de café', 15, NULL, 1, 1),
(75, 'Guji Ethiopie naturel', 3, 11, 'Berceau du café, ce cru produit dans la région de Guji est séché naturellement au soleil pour transférer les sucres présent dans la chair du fruit au grain de café', 14, NULL, 1, 1),
(76, 'Machine Automatique Mélitta Solo Noir', 3, 14, 'Machine automatique avec moulin intégré, réservoir d\"eau + 1kg de café offert Pérou Bio Commerce équitable', 22, NULL, 1, 1),
(77, 'cafetière', 3, 14, 'Machine à café vendue avec 3 adaptateurs : Café moulu, Capsules Nespresso et Capsules Dolce Gusto. Une machine compact et facile d\"utilisation. Fournit avec un tampeur et une cuillère doseuse.', 2, NULL, 1, 1),
(78, 'Tea maker 0.5l', 3, 14, '', 50, NULL, 1, 1),
(79, 'Orangette chocolat noir  - 100g', 3, 19, '', 21, NULL, 1, 1),
(80, 'Caramel à l\'O - 230g', 3, 19, 'Elaboré par la Confiserie Lou Sucrèu St Haon-le-Châtel avec l\"eau Thermale de Salins les Bains, Jura\nIngrédients : crème, sucre, glucose, beurre, sel 1,2%.\nSans huile de palme', 32, NULL, 1, 1),
(81, 'Nougatine amandes - 150g', 3, 19, 'Fabrication artisanale par la Confiserie \"La Sucrerie\" - 39600 Arbois, JURA\nIngrédients : glucose, sucre, amandes, beurre', 6, NULL, 1, 1),
(82, 'Miel forêt - 250g', 3, 19, 'Miel du JURA - 39190 Val-Sonnette', 48, NULL, 1, 1),
(83, 'Nougatine sésame - 150g', 3, 19, 'Fabrication artisanale par la Confiserie \"La Sucrerie\" - 39600 Arbois, JURA\nIngrédients : glucose, sucre, lin,  sésame, beurre\nTraces possibles de fruits à coque', 37, NULL, 1, 1),
(84, 'Miel Tilleul - 250g', 3, 20, 'Miel du JURA - 39190 Val-Sonnette', 37, NULL, 1, 1),
(85, 'Infusion Tout en douceur - 50g', 3, 21, '', 45, NULL, 1, 1),
(86, 'Infusion Camomille - 50g', 3, 22, '', 11, NULL, 1, 1),
(87, 'Infusion Fruits rouges - 100g', 3, 22, '', 15, NULL, 1, 1),
(88, 'Infusion Mangue - 100g', 3, 22, '', 11, NULL, 1, 1),
(89, 'Infusion Menthe - 50g', 3, 22, '', 50, NULL, 1, 1),
(90, 'Thé noir caramel beurre salé - 100g', 3, 22, 'Du caramel fondant et doux accompagné d\"un soupçon de sel de perles africaines ajoutés aux morceaux de crème et d\"amandes... Il n\"en fallait pas plus pour inventer cette noble création gourmande.', 23, NULL, 1, 1),
(91, 'Darjeeling First Flush - 100g', 3, 22, 'Signifiant \"pays des orages\" en langue tibétaine. Plantation de thé noir issue de la région d\"Inde portant le même nom, elle est la seule à bénéficier d\"une Indication Géographique Protégée (IGP) pour lutter contre les nombreuses contrefaçons existantes.\nLe thé peut être récolté jusqu\"à 4 fois par an, celle du printemps, la première récolte, ou \"First Flush\" est très attendue des amateurs qui la qualifient de \"Champagne du thé\".\nElle offre un thé léger et délicat aux notes fraîches et intenses, merveilleusement élaboré et présentant un caractère frais, légèrement épicé. ', 1, NULL, 1, 1),
(92, 'English Breakfast - 100g', 3, 22, 'Ce mélange So British de culture biologique contrôlée est composé essentiellement de thés Assam. D\"abord réservée à l\"élite anglaise, la consommation du \"five o\"clock tea\" se démocratise au XIXe siècle. Depuis l\"époque coloniale, les Britanniques ont pour habitude de consommer des thés noirs plus corsés le matin comme ce ENGLISH BREAKFAST. Ce thé, à la fois puissant et aromatique, révèle une tasse foncée d\"un brun cuivré et un bouquet plein et épicé. ', 46, NULL, 1, 1),
(93, 'Roiboos bergamote - 100g', 3, 22, '', 4, NULL, 1, 1),
(94, 'Rooibos aloe vera melon', 3, 22, '', 44, NULL, 1, 1),
(95, 'Rooibos Cranberry vanille - 100g', 3, 22, '', 25, NULL, 1, 1),
(96, 'Rooibos Rhubarbe framboise - 100g', 3, 22, '', 15, NULL, 1, 1),
(97, 'Thé blanc Chine - 50g', 3, 22, 'Ce thé du Yunnan est cultivé à une altitude comprise entre 1300 et 2000m d\"altitude et à des températures allant de 12 à 23°C. Ses grandes feuilles ouvertes vert clair et la large proportion de pointes argentées laissent un bouquet doux et fleuri en bouche. La liqueur a un parfum fleuri dont la couleur rappelle le lever du soleil.Le THE BLANC est celui qui nécessite le temps d\"infusion le moins long, l\"eau la moins chaude et est celui qui subit le moins de transformation.', 45, NULL, 1, 1),
(98, 'Thé noir Ceylan - 100g', 3, 22, 'Jusqu’au milieu du XIXème siècle, on consommait à Ceylan exclusivement du café. Cependant, dans les années 1850, un parasite ravagea les plantations de café de l’île, ce qui obligea les cultivateurs anglais à recourir à une autre plante : les théiers. C’est ainsi que le thé fit son apparition au Sri Lanka.\nCe Ceylan organique provient de la vallée de Bogawantalwa dans l\"ouest du Sri Lanka. Les feuilles courtes et foncées d\"un brun rouillé développent une tasse brillante de couleur cuivrée et une infusion rouge vif. Le bouquet vous impressionnera par son goût plein et un arôme doux et épicé, qui laisse un arrière-goût très riche.  ', 13, NULL, 1, 1),
(99, 'Thé noir Chine - 100g', 3, 22, 'La qualité supérieure de ce thé noir du Yunnan se présente magnifiquement avec beaucoup de grandes pointes de feuilles brun doré et une infusion brun cuivré foncé avec un goût bien équilibré et des notes légèrement douces et épicées. Elle vous laissera avec une touche finale douce et légèrement fumée. ', 28, NULL, 1, 1),
...
(101, 'Thé noir Inde - 100g', 3, 22, 'Ce thé noir du Sud de l\"Inde du jardin Thiashola a une saveur fraîche et légèrement tranchante avec un certain corps. Une feuille multicolore et inégale avec des tâches vertes. La couleur de coupe d\"un rouge cuivre offre un parfum de fleurs fraîches. ', 1, NULL, 1, 1),
(102, 'Thé noir mangue - 100g', 3, 22, '', 15, NULL, 1, 1),
(103, 'Thé noir orange - 100g', 3, 22, 'Aussi rafraîchissant et vitaminé qu\"un jus d\"orange pressé, ce thé noir, frais et vif, sera votre allié pour démarrer votre journée du bon pied ! ', 1, NULL, 1, 1),
(104, 'Thé noir pêche - 100g', 3, 22, 'Ce thé de Ceylan doux décoré avec les couleurs de différentes fleurs et le bleu profond et scintillant de fleurs de bleuet est une promesse de détente complète. Cet arôme est composé des fruits les plus exotiques au monde et d\"un soupçon de crème douce qui fait errer vos pensées, vous permettant de profiter d’un moment de relaxation parfait et de recueillir de nouvelles forces. ', 32, NULL, 1, 1),
(105, 'Thé vert citron jasmin - 100g', 3, 22, '', 26, NULL, 1, 1),
(106, 'Thé vert fraise litchi - 100g', 3, 22, '', 34, NULL, 1, 1),
(107, 'Thé vert Inde - 100g', 3, 22, 'Au cours des dernières années, la plantation Nagri Farm, qui se trouve dans la vallée de Rongbong, a acquis une réputation exceptionnelle pour la production de thé vert. La plantation est répartie sur une superficie de 571 hectares à des altitudes allant jusqu’à 1400 m et a une production annuelle d’environ 190000 kg de thé. Les buissons poussent lentement dans l’air frais de la montagne et l’arôme et les feuilles peuvent se développer parfaitement dans ces conditions idéales. La feuille verte régulière a quelques pointes argentées et présente son caractère classique, rond et doux dans une tasse jaune citron. ', 29, NULL, 1, 1),
(108, 'Thé vert Japon - 50g', 3, 22, '', 47, NULL, 1, 1),
(109, 'Thé vert jasmin - 100g', 3, 22, 'Avec une tasse légèrement jaune et le parfum expressif et typique de jasmin ainsi qu\"une légère note fruitée-acidulée, ce thé au jasmin est un compagnon idéal pour chaque repas et un vrai désaltérant. Selon la qualité de l’eau, le thé peut être infusé plus d’une fois', 5, NULL, 1, 1),
(110, 'Thé vert mangue ananas - 100g', 3, 22, '', 42, NULL, 1, 1),
(111, 'Thé vert poire - 100g', 3, 22, '', 23, NULL, 1, 1),
(112, 'Thé vert Vanille jasmin - 100g', 3, 22, '', 15, NULL, 1, 1),
(113, 'Thé vert Vietnam - 100g', 3, 22, '', 35, NULL, 1, 1),
(114, 'Infusion Noix de coco aloé vera - 100g', 3, 22, '', 10, NULL, 1, 1),
(115, 'Infusion Pina Colada -100g', 3, 22, '', 3, NULL, 1, 1),
(116, 'Infusion Poire cannelle - 100g', 3, 22, '', 15, NULL, 1, 1),
(117, 'Infusion Tilleul - 50g', 3, 22, '', 15, NULL, 1, 1),
(118, 'Thé vert pêche - 100g', 3, 22, '', 18, NULL, 1, 1),
(119, 'Thé vert mirabelle - 100g', 3, 22, '', 3, NULL, 1, 1),
(120, 'Thé vert figue baies rouges - 100g', 3, 22, '', 22, NULL, 1, 1),
(121, 'Thé vert pomme gingembre - 100g', 3, 22, '', 20, NULL, 1, 1),
(122, 'Thé vert cerise - 100g', 3, 22, 'Ce thé vert est une invitation au voyage... L\"excellente base abondamment décorée de pétales de rose, et son parfum fruité de cerise n\"est pas sans rappeler les magnifiques jardins japonais durant la saison de floraison des cerisiers... ', 20, NULL, 1, 1),
(123, 'Oolong Vietnam - 100g', 3, 22, 'Thé désigné sous le nom de « bleu vert » à mi chemin entre le thé vert non oxydé et le thé noir complétement oxydé. Qualifié de thé semi-oxydé, faible en théine il sera à déguster tout au long de la journée. Issu de la ville de Bao Loc, où sont produits des Oolong en utilisant les méthodes taïwanaises anciennes. Les feuilles de thé fraîchement cueillies sont séchées puis écrasées pour commencer la fermentation. Après avoir atteint le niveau de fermentation souhaité, le thé est séché à basse température. La tasse verte rayonnante caresse les papilles de chacun avec sa saveur fleurie et sucrée. ', 36, NULL, 1, 1),
(124, 'Croisière sur le Nil - 100g', 3, 22, '', 50, NULL, 1, 1),
(125, 'L\'ambroisie du dragon 100g', 3, 22, '', 48, NULL, 1, 1),
(126, 'Maté della Melagrana - 100g', 3, 22, '', 29, NULL, 1, 1),
(127, 'Bâton de réglisse 100g', 3, 22, '', 49, NULL, 1, 1),
(128, 'Thé vert citron - 100g', 3, 22, '', 38, NULL, 1, 1),
(129, 'Thé vert coco ananas - 100g', 3, 22, '', 33, NULL, 1, 1),
(130, 'Thé vert ananas fraise - 100g', 3, 22, '', 30, NULL, 1, 1),
(131, 'Earl Grey - 100g', 3, 22, '', 23, NULL, 1, 1),
(132, 'Infusion Chaï - 100g', 3, 22, '', 24, NULL, 1, 1),
(133, 'Maté - 100g', 3, 22, '', 20, NULL, 1, 1),
(134, 'Lapsang Souchong - 100g', 3, 22, '', 27, NULL, 1, 1),
(135, 'Doux nectar - 100g', 3, 22, '', 4, NULL, 1, 1),
(136, 'Thé vert cactus ananas - 100g', 3, 22, '', 7, NULL, 1, 1),
(137, 'Symphonie - 15 infusettes', 3, 23, 'Raisin de Corynthe, Cynorrhodon, Hibiscus, Orange, Ananas, Papaye, arômes', 16, NULL, 1, 1),
(138, 'Digestive - 15 infusettes', 3, 23, 'Menthe Poivrée BIO plante, Mélisse BIO plante, Angélique BIO fruit, Anis Vert BIO fruit, Fenouil BIO fruit', 20, NULL, 1, 1),
(139, 'Au clair de la Lune - 15 infusettes', 3, 23, 'Oranger Doux feuille, Passiflore des Indes, Mélisse, Verveine Odorante, Aspérule Odorante', 14, NULL, 1, 1),
(140, 'Camomille - 15 infusettes', 3, 23, 'Camomille Bio', 50, NULL, 1, 1),
(141, 'Infusion Tilleul - 15 infusettes', 3, 23, 'Tilleul', 15, NULL, 1, 1),
(142, 'Infusion Verveine - 15 infusettes', 3, 23, 'Verveine Bio', 24, NULL, 1, 1),
(143, 'Tisane de Noël - 15 infusettes', 3, 23, 'Cannelle, Orange Douce, Badiane, Hibiscus, Orange Amère, Cardamome', 42, NULL, 1, 1),
(144, 'Transit - 15 infusettes', 3, 23, 'Anis Vert, Menthe Douce, Citronnelle', 17, NULL, 1, 1);
...
(1, 'En attente de validation', 'Le client à passer sa commande et le serveur doit la valider'),
(2, 'En préparation', 'La commande est validé, elle est en cours de préparation'),
(3, 'Accepter ', 'La commande est accepter '),
(4, 'Refuser', 'La commande est refuser'),
(5, 'En attente de livraison en salle', 'La commande est prête et doit etre livrer a la table'),
(6, 'Livrée avec attente de payement ', 'La commande est livrée et on attend le payement du client'),
(7, 'Livrée et payer ', 'La commande et livrée et payer par le client'),
(8, 'Terminer', 'La commande est terminer, plus aucune action à réaliser '),
(9, 'Livrée et non payer ', 'Le client n\'as pas payer sa commande');
...
--
ALTER TABLE `declinaison`
  MODIFY `id_declinaison` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
